...
var favouriteColors = ['red', 'blue', 'green', 'purple'];
...
for (var i = 0; i < favouriteColors.length; i++ ) {
	...
	if (i === 0) {
		console.log("1st choice is " + favouriteColors[i]);
	}	
	else if (i === 1) {
		console.log("2nd choice is " + favouriteColors[i]);
	}
	else if (i === 2) {
		console.log("3rd choice is " + favouriteColors[i]);
	}
	else {
		console.log("My " + i + "th choice is " + favouriteColors[i]);
	}
}
...
else if (studentChoice === "Steak" || studentChoice === "pork chops")fruit salad, tofurkey
{
